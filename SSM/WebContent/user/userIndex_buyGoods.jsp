	...
	<div class="container-fluid">
		<div class="row">
			<nav class="col-md-2 d-none d-md-block bg-light sidebar">
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						<li class="nav-item"><a class="nav-link" href="../userHome">
					...
					<ul class="nav flex-column mb-2">
						...
						<li class="nav-item"><a class="nav-link" href="../userReceive/${User.uid}"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
									class="feather feather-file-text">
			...
			<div class="my-4 chartjs-render-monitor" id="myChart" width="1076"
				...
				<form action="../insertBuyInfor" method="post">
					<input type="hidden" name="user.uid" value="${User.uid}">
					<table>
						<tr>
							<td>商品标号：</td>
							<td><input type="number" name="goods.gid"
								value="${goods.gid}" readonly="readonly"></td>
						</tr>
						<tr>
							<td>商品名称：</td>
							<td><input type="text" name="goods.gname"
								value="${goods.gname}" readonly="readonly"></td>
						</tr>
						<tr>
							<td>商品价格：</td>
							<td><input type="number" name="goods.price"
								value="${goods.price}" readonly="readonly"></td>
						</tr>
						<tr>
							<td>所属商家：</td>
							<td><input type="text" name="goods.market.mname"
								value="${goods.market.mname}" readonly="readonly"></td>
						</tr>
						<tr>
							<td>商家编号：</td>
							<td><input type="number" name="goods.market.mid"
								value="${goods.market.mid}" readonly="readonly"></td>
						</tr>
						<tr>
							<td>收件人：</td>
						...
						<tr>
							...
							<td><button><a href="../userSelectAllGoods" style="color: black;">取消</a></button></td>
						</tr>
					</table>
				</form>
			</div>
