			...
			<nav class="col-md-2 d-none d-md-block bg-light sidebar">
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a class="nav-link" href="userSelectAllGoods"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
			...
			<div class="my-4 chartjs-render-monitor" id="myChart" width="1076"
				...
				<form>
					<table>
						<tr>
							<td>用户账号：</td>
							<td><input type="number" value="${User.uid}"
								readonly="readonly"></td>
						</tr>
						<tr>
							<td>用户密码：</td>
							<td><input type="text" value="${User.upwd}"
								readonly="readonly"></td>
						</tr>
						<tr>
							<td>用户姓名：</td>
							<td><input type="text" value="${User.uname}"
								readonly="readonly"></td>
						</tr>
						<tr>
							<td>用户性别：</td>
						...
						<tr>
							<td>用户生日：</td>
							<td><input type="text" value="${User.year}"
								readonly="readonly"></td>
						</tr>
						<tr>
							<td>用户地址：</td>
							<td><input type="text" value="${User.uaddress}"
								readonly="readonly"></td>
						</tr>
						<tr>
							<td>
								<button>
									<a href="myUserUpdate" style="color: black;">修改</a>
								</button>
							</td>
						</tr>
					</table>
