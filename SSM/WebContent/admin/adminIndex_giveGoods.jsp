...
<body>
	<nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
		<a class="navbar-brand col-sm-3 col-md-2 mr-0" href="">${Admin.did}</a>
	...
	<div class="container-fluid">
		<div class="row">
			<nav class="col-md-2 d-none d-md-block bg-light sidebar">
				<div class="sidebar-sticky">
					...
					<ul class="nav flex-column mb-2">
						<li class="nav-item"><a class="nav-link" href="../adminAllGiveInfor"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
									class="feather feather-file-text">
			...
			<form action="../insertGiveInfor" method="post">
				<table>
					<tr>
						<td>订单编号：</td>
						<td><input type="text" name="buy.bid"
							value="${selectBuyInfor.bid}" readonly="readonly" /></td>
					</tr>
					<tr>
						<td>配送物品：</td>
						<td><input type="text" name="buy.goods.gname"
							value="${selectBuyInfor.goods.gname}" readonly="readonly"></td>
					</tr>
					<tr>
						<td>发货地址：</td>
						<td><input type="text" name="buy.goods.market.maddress"
							value="${selectBuyInfor.goods.market.maddress}"
							readonly="readonly"></td>
					</tr>
					<tr>
						<td>收货地址：</td>
						<td><input type="text" name="buy.raddress"
							value="${selectBuyInfor.raddress}" readonly="readonly"></td>
					</tr>
					<tr>
						<td>选择配送员工：</td>
						<td><select name="emp.eid">
								<c:forEach items="${selectAllEmp}" var="emp">
									<option value="${emp.eid}">${emp.ename}</option>
								</c:forEach>
						</select></td>
					</tr>
					<tr>
						<td><input type="submit" value="开始配送"></td>
						<td>
							<button>
								<a href="../adminAllSendInfor" style="color: black">取消</a>
							</button>
						</td>
					</tr>
				</table>
