		...
		<div class="row">
			...
			<div class="my-4 chartjs-render-monitor" id="myChart" width="1076"
				...
				<form action="../UpdateMarket" method="post">
					<input type="hidden" value="${marketByMid.mpwd }" name="mpwd">
					<table>
						<tr>
							<td>商家账号：</td>
							<td><input type="number" value="${marketByMid.mid }"
								name="mid" readonly="readonly" /></td>
						</tr>
						<tr>
							<td>商家名称：</td>
							<td><input type="text" value="${marketByMid.mname }"
								name="mname" /></td>
						</tr>
						<tr>
						<tr>
							<td>商家地址：</td>
							<td><input type="text" value="${marketByMid.maddress}"
								name="maddress"></td>
						</tr>
						<tr>
							...
							<td>
								<button>
									<a href="../getAllMarket" style="color: black">取消</a>
								</button>
							</td>
						</tr>
					</table>
