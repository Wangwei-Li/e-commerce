	...
	<div class="container-fluid">
		<div class="row">
			...
			<div
				...
				<h1 class="h2">员工信息</h1>
				<button class="btn btn-sm btn-success" style="float: right;"><a href="adminInsertEmpJsp" style="color: white;">添加员工</a></button>
			</div>
					...
					<tbody>
						<c:forEach items="${selectAllEmp}" var="emp">
							<tr>
								...
								<td>${emp.scope}</td>
								<td>
									<button class="btn btn-sm btn-primary"><a href="adminUpdateEmpJsp/${emp.eid}" style="color: white">修改</a></button>
									<button class="btn btn-sm btn-danger"><a href="deleteEmp/${emp.eid}" style="color: white">删除</a></button>
								</td>
							</tr>
						</c:forEach>
					</tbody>
