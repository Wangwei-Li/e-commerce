		...
		<div class="row">
			<nav class="col-md-2 d-none d-md-block bg-light sidebar">
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a class="nav-link" href="getAllUser"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
			...
			<div
				...
				<table class="table table-striped table-sm">
					...
					<tbody>
						<c:forEach items="${selectAllBuyInfor}" var="infor">
							<tr>
								<td>${infor.bid}</td>
								<td>${infor.goods.gname}</td>
								<td>${infor.goods.gid}</td>
								<td>${infor.goods.price}</td>
								<td>${infor.goods.market.mname}</td>
								<td>${infor.goods.market.maddress}</td>
