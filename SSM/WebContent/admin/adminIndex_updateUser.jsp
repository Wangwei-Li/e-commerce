		...
		<div class="row">
			<nav class="col-md-2 d-none d-md-block bg-light sidebar">
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a class="nav-link" href="../adminAllBuyInfor"> <svg
									xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
									class="feather feather-file-text">
			...
			<div class="my-4 chartjs-render-monitor" id="myChart" width="1076"
				...
				<form action="../UpdateUser" method="post">
					<input type="hidden" value="${userByUid.upwd }" name="upwd">
					<table>
						<tr>
							<td>用户账号：</td>
							<td><input type="number" value="${userByUid.uid }"
								name="uid" readonly="readonly" /></td>
						</tr>
						<tr>
							<td>用户姓名：</td>
							<td><input type="text" value="${userByUid.uname }"
								name="uname" /></td>
						</tr>
						<tr>
							<td>用户性别：</td>
							<td><input type="text" value="${userByUid.sex}" name="sex" /></td>
						</tr>
						<tr>
							<td>用户生日：</td>
							<td><input type="text" value="${userByUid.year}" name="year"></td>
						</tr>
						<tr>
							<td>用户地址：</td>
							<td><input type="text" value="${userByUid.uaddress}"
								name="uaddress"></td>
						</tr>
						<tr>
							...
							<td>
								<button>
									<a href="../getAllUser" style="color: black">取消</a>
								</button>
							</td>
						</tr>
					</table>
