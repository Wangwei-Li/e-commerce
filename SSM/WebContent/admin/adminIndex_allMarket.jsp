	...
	<div class="container-fluid">
		<div class="row">
			...
			<div
				...
				<h1 class="h2">商家信息</h1>
				<button class="btn btn-sm btn-success" style="float: right;"><a href="adminInsertMarketJsp" style="color: white;">添加商家</a></button>
			</div>
			<div class="table-responsive">
				<table class="table table-striped table-sm">
					...
					<tbody>
						<c:forEach items="${getAllMarket}" var="market">
							<tr>
								<td>${market.mid}</td>
								<td>${market.mpwd}</td>
								<td>${market.mname}</td>
								<td>${market.maddress}</td>
								<td>
									<button class="btn btn-sm btn-primary"><a href="getMarketByMid/${market.mid}" style="color: white">修改</a></button>
									<button class="btn btn-sm btn-danger"><a href="deleteMarketByMid/${market.mid}" style="color: white">删除</a></button>
								</td>
							</tr>
						</c:forEach>
					</tbody>
