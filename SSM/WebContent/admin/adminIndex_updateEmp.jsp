			...
			<div class="my-4 chartjs-render-monitor" id="myChart" width="1076"
				...
				<form action="../updateEmp" method="post">
					<table>
						<tr>
							<td>员工id：</td>
							<td><input type="number" value="${empByEid.eid }" name="eid"
								readonly="readonly" /></td>
						</tr>
						<tr>
							<td>员工姓名：</td>
							<td><input type="text" value="${empByEid.ename }"
								name="ename" /></td>
						</tr>
						<tr>
						<tr>
							<td>联系电话：</td>
							<td><input type="text" value="${empByEid.ephone}"
								name="ephone"></td>
						</tr>
						<tr>
							<td>使用车辆：</td>
						...
						<tr>
							<td>配送范围：</td>
							<td><input type="text" value="${empByEid.scope}"
								name="scope"></td>
						</tr>
						<tr>
							...
							<td>
								<button>
									<a href="../adminAllEmployee" style="color: black">取消</a>
								</button>
							</td>
						</tr>
					</table>
