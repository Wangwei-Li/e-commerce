	...
	<div class="container-fluid">
		<div class="row">
			...
			<table class="table table-striped table-sm">
				...
				<tbody>
					<c:forEach items="${selectAllSendInfor}" var="infor">
						<tr>
							<td>${infor.buyinfor.bid}</td>
							<td>${infor.buyinfor.goods.gname}</td>
							<td>${infor.buyinfor.user.uid}</td>
							<td>${infor.buyinfor.goods.market.mname}</td>
							<td>${infor.buyinfor.goods.market.maddress}</td>
							<td>${infor.buyinfor.recipient}</td>
							<td>${infor.buyinfor.phone}</td>
							<td>${infor.buyinfor.raddress}</td>
							<td>已发货，请配送</td>
							<td>
								<button class="btn btn-sm btn-primary">
									<a href="giveGoodsJsp/${infor.buyinfor.bid}" style="color: white">配送</a>
								</button>
							</td>
						</tr>
					</c:forEach>
