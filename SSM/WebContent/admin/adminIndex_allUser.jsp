	...
	<div class="container-fluid">
		<div class="row">
			<nav class="col-md-2 d-none d-md-block bg-light sidebar">
				<div class="sidebar-sticky">
					<ul class="nav flex-column">
						...
						<li class="nav-item"><a class="nav-link" href="getAllMarket">
								<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
									viewBox="0 0 24 24" fill="none" stroke="currentColor"
									stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
									class="feather feather-file-text">
			...
			<div
				...
				<h1 class="h2">用户信息</h1>
				<button class="btn btn-sm btn-success" style="float: right;"><a href="adminInsertUserJsp" style="color: white;">添加用户</a></button>
			</div>
					...
					<tbody>
						<c:forEach items="${getAllUser}" var="user">
							<tr>
								...
								<td>${user.uaddress}</td>
								<td>
									<button class="btn btn-sm btn-primary"><a href="getUserByUid/${user.uid}" style="color: white">修改</a></button>
									<button class="btn btn-sm btn-danger"><a href="deleteUserByUid/${user.uid}" style="color: white">删除</a></button>
								</td>
							</tr>
						</c:forEach>
					</tbody>
